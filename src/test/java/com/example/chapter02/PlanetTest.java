...
import com.example.chapter02.challenge.Planet;
import com.example.chapter02.challenge.PlanetUtils;
import com.example.chapter02.challenge.SolarSystem;
...
class PlanetTest {
    ...
    final private List<Planet> planets = SolarSystem.getPlanets();
    final private PlanetUtils planetUtils = new PlanetUtils();
